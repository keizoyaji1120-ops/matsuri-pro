...
st.markdown("""
    ...
    /* v15.1: 指数表示用の色定義 (アイコンなし) */
    .fc-score-high { color: #e74c3c; font-weight: 900; font-size: 16px; } /* 高スコア: 赤太字 */
    .fc-score-mid { color: #f39c12; font-weight: 900; font-size: 15px; } /* 中スコア: オレンジ太字 */
    .fc-score-low { color: #bdc3c7; font-weight: bold; } /* 低スコア: グレー */
    ...
    with st.spinner('解析中...'):
        ...
        if data:
            ...
            for i in range(1, 5):
                ...
                # スコア装飾 (v15.1 変更: アイコン削除・数値のみで色分け)
