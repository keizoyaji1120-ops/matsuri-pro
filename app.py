...
st.markdown("""
    ...
    .weight-val { font-weight: bold; font-size: 28px; color: #d63031; line-height: 1.2; } /* 文字サイズアップと行間調整 */
...
# --- 戦略計算 (v16.2 修正: 水深別ネクタイ形状・レイアウト修正) ---
