...
st.markdown("""
    ...
    .footer-box {
        ...
        padding: 15px; margin-top: 30px; font-size: 12px; color: #555;
    }
    .footer-title { font-weight: bold; color: #d63031; margin-bottom: 10px; font-size: 14px; }
    </style>
...
def calc_strategy_realtime(wind_spd, wind_dir, tide_factor, is_rising, temp, cloud, rain):
    # 潮の角度設定（明石海峡はおおよそ 西=280度、東=100度方向に流れる）
    ...
    if temp < 12.0:
        tie_size = "極細ショート / ストレート" # 冬・低水温（海苔パターン）
    elif tide_factor < 0.2:
        tie_size = "ショート / スリム" # 潮止まり
    elif rain > 0.5:
        tie_size = "ワイド / 強波動" # 濁りで見つけてもらう
...
def main():
    st.markdown("""
        ...
        <p style='text-align: center; font-size: 14px; color: gray;'>
            Real-time Akashi Tai-Raba Strategy v3.1 (TG Edition)
        </p>
    """, unsafe_allow_html=True)
    ...
    <div class="footer-box">
        ...
        <ul>
            ...
            本アプリの提案は推測ロジックに基づくものであり、実際の海況や釣果を保証するものではありません。特に潮流情報は計算値であり、実際の現場（反転流など）と異なる場合があります。</li>
