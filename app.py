...
# --- 天気取得 (v20.1: 定点観測フリーズ対策・ショートカット機能) ---
@st.cache_data(ttl=300) 
def get_current_weather(lat, lon):
    
    # 1. 座標がデフォルト(橋の下)とほぼ同じなら、最初から沖合ポイントを使用する (フリーズ回避)
